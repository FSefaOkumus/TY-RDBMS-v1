...
public class CustomerController {
    ...
    public ResponseEntity<Customer> addNewCustomer(@Valid @RequestBody Customer customer)
    {
        ...
        Profile profile = new Profile(customer, customer.getProfile().getFirstName(), customer.getProfile().getLastName(),customer.getProfile().getBirthday(),customer.getProfile().getAddress(),customer.getProfile().getEmailAddress(), customer.getProfile().getGender());
